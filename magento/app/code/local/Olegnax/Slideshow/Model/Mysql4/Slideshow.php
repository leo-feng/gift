...
class Olegnax_Slideshow_Model_Mysql4_Slideshow extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        // Note that the slide_id refers to the key field in your database table.
        $this->_init('slideshow/slideshow', 'slide_id');
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $this->_getWriteAdapter()->delete($this->getTable('slideshow/slideshow_store'), $condition);
        ...
        foreach ((array)$object->getData('stores') as $store) {
            ...
            $this->_getWriteAdapter()->insert($this->getTable('slideshow/slideshow_store'), $storeArray);
        }
